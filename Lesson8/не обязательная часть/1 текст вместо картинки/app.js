...
function handleClick(clickedButtonEvent) {
  ...
  const card = {
    ...
    productName: cardNode.querySelector(".productName").textContent, // здесь .productName, который внутри .product
...
function showMoreText(card) {
  ...
  let text = "Этот текс - произвольный!";
  ...
  card.wrap
    ...
    .insertAdjacentHTML("afterend", `<div class="desc">${text}</div>`);
